...
=begin 
       Powred By DARKBOSS1BD 
                The DARKBOSS1 Hack Team (:
=end
require "rest-client"
require "nokogiri"
require "colorize"
...
puts "
  ...
  __| _/____ _______|  | _\_ |__   ____  ______ _____/_   \_ |__    __| _/
 / __ |\__  \\_  __ \  |/ /| __ \ /  _ \/  ___//  ___/|   || __ \  / __ | 
/ /_/ | / __ \|  | \/    < | \_\ (  <_> )___ \ \___ \ |   || \_\ \/ /_/ | 
\____ |(____  /__|  |__|_ \|___  /\____/____  >____  >|___||___  /\____ | 
     \/     \/           \/    \/           \/     \/          \/      \/  
                                                                 ".red                                                                             
puts  "
...
if $option == "uptd" then 
system("git clone https://github.com/darkboss1bd/darkboss1bd-kill-web.git")
end
if $option == "site" then
